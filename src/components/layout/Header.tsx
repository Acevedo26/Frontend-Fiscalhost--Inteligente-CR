            ...
            {showProfile && (
              <div className="header-dropdown">
                <div className="header-dropdown-header">
                  <span className="header-dropdown-name">Juan Díaz</span>
                  <span className="header-dropdown-email">juan@email.com</span>
                </div>
                ...
                <button className="header-dropdown-item header-dropdown-item-danger">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
